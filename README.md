# ![LOGO](logo.png) Amazon DynamoDB Accelerator (DAX) MSP Connector

## Description

A generated MSP connector for the Amazon DynamoDB Accelerator (DAX) API (version 2017-04-19).
...
flowground :- Telekom iPaaS / amazonaws-com-dax-connector<br/>
